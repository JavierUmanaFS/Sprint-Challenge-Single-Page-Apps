...
> Answer:
Allows for more interactivity with immediate responses to users actions.
Executes quickly because they dont take a trip to the server.
Re-usable.
Dynamic.
Instant feedback.
Gives developers more control over the look and behavior.
